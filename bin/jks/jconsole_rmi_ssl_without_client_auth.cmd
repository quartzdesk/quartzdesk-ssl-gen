...
"%JAVA_HOME%\bin\jconsole.exe" -J-Djavax.net.debug=ssl -J-Djavax.net.ssl.trustStore=output\jmx-client-truststore.jks -J-Djavax.net.ssl.trustStorePassword=password123
