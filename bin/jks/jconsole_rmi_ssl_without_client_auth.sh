...
if [ -z "${JAVA_HOME}" ]; then
    ...
    "${JAVA_HOME}/bin/jconsole" -J-Djavax.net.debug=ssl -J-Djavax.net.ssl.trustStore=output/jmx-client-truststore.jks -J-Djavax.net.ssl.trustStorePassword=password123
fi
